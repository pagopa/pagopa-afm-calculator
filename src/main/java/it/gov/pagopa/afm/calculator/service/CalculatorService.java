...
//        Map<String, Long> feePerPsp = new HashMap<>();
//        List<Transfer> result = new ArrayList<>();
//        for (int i = 0; i < transfers.size(); i++) {
//            var transfer = transfers.get(i);
//            if(feePerPsp.containsKey(transfer.getIdPsp())) {
//                var c = feePerPsp.get(transfer.getIdPsp());
//
//
//            } else {
//                feePerPsp.put(transfer.getIdPsp(), transfer.getTaxPayerFee());
//            }
//        }
