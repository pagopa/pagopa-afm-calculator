...
class ConfigurationServiceTest {
  ...
  @MockBean ValidBundleRepository validBundleRepository;

  @MockBean TouchpointRepository touchpointRepository;

  @MockBean PaymentTypeRepository paymentTypeRepository;
