...
class CalculatorServiceTest {
    ...
    // @Test
    // @Order(9)
    // void calculate_BIN_with_different_ABI_error() throws IOException,
    // JSONException {
    ...
    //
    // var paymentOption =
    // TestUtil.readObjectFromFile("requests/getFeesBINwithMultipleABI.json",
    // PaymentOption.class);
    //
    // AppException exception =
    // assertThrows(
    // AppException.class, () -> calculatorService.calculate(paymentOption, 10,
    // true));
    //
    ...
    // This must be the last test to run - it needs to mock the cosmosRepository in
    // the service
    @Test
    ...
    // @Test
    // @Order(20)
    // void calculateMulti_BIN_with_different_ABI_error() throws IOException,
    // JSONException {
    // Touchpoint touchpoint = TestUtil.getMockTouchpoints();
    // PaymentType paymentType = TestUtil.getMockPaymentType();
    //
    ...
    //
    // var paymentOption =
    // TestUtil.readObjectFromFile("requests/getFeesMultiBINwithMultipleABI.json",
    // PaymentOptionMulti.class);
    //
    // AppException exception =
    // assertThrows(
    ...
    void calculateMultiFullCommission() throws IOException, JSONException {
        ...
        when(cosmosTemplate.findAll(ValidBundle.class)).thenReturn(Collections.singletonList(validBundle));
    ...
    void calculateMultipleBundlesRandomOrderOnusFirst() throws IOException {
        ...
        // Check that the first element has onUs == true, the other elements have set to
        // false
        assertEquals(true, result.getBundleOptions().get(0).getOnUs());
    ...
    void calculateMultipleBundlesPspNameOrderOnusFirst() throws IOException {
        ...
        // Check that the Psp Names are in ascending order and the first element has
        // onUs == true
        var options = result.getBundleOptions();
        for (int i = 1; i < options.size(); i++) {
            int prevFeeIndex = i - 1;
