...
jq '.paths."/psps/fees/{idPsp}" = .paths."/psps/{idPsp}/fees/multi" | del( .paths."/psps/{idPsp}/fees/multi")' ./openapi/openapi-node-v2.json > ./openapi/temp.json.temp && mv ./openapi/temp.json.temp ./openapi/openapi-node-v2.json